...
Peti panduan ini membantu model AI yang baru masuk ke repositori untuk menemukan berkas referensi utama (ADR, RFC, pengujian, contoh, dan kontrak) tanpa perlu menebak lokasi berkas.
...
- **Berkas Detil**: Seluruh berkas ADR aktif disimpan dengan format penamaan `ADR-XXXX-Judul-Keputusan.md` di folder `docs/id/adr/`.
- **ADR Deprecated**: Catatan sejarah yang telah digantikan disimpan di folder `docs/archive/` (misal: `0001-use-langgraph.md`).

### 2. Menemukan Usulan Fitur (RFC)
- **Log Utama**: [docs/id/rfc/README.md](../../docs/id/rfc/README.md)
- **Berkas Detil**: Disimpan di folder `docs/id/rfc/` dengan format `rfc-XXXX-nama-fitur.md`.
...
Setiap kali Chief Architect menginstruksikan modifikasi fitur:
